...
public class Fonction {
	...
	public Fonction(String fonctionname, Boolean vieworderPanel, Boolean neworderPanel, Boolean expensesPanel, Boolean settingsPanel, Boolean reportsPanel, Boolean menuitemsPanel) {
