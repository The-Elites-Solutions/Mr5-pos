...
public class HomeScreen {
	...
	protected void btnNewOrderAction() {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(HomeScreen.class.getResource("NewOrder.fxml"));
	...
	protected void btnViewOrderAction() {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(HomeScreen.class.getResource("ViewOrder.fxml"));
			Parent root = (Parent) fxmlLoader.load();
	...
	protected void btnMenuItemsAction() {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(HomeScreen.class.getResource("MenuItems.fxml"));
			Parent root = (Parent) fxmlLoader.load();
	...
	protected void btnExpensesAction() {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(HomeScreen.class.getResource("Expenses.fxml"));
			Parent root = (Parent) fxmlLoader.load();
	...
	protected void btnReportsAction() {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(HomeScreen.class.getResource("Reports.fxml"));
			Parent root = (Parent) fxmlLoader.load();
	...
	protected void btnSettingsAction() {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(HomeScreen.class.getResource("Settings.fxml"));
			Parent root = (Parent) fxmlLoader.load();
	...
	protected void btnPowerOffAction() {
		...
		try {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(HomeScreen.class.getResource("PowerOff.fxml"));
			Parent root = (Parent) fxmlLoader.load();
